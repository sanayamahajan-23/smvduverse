...
const SMVDUMap = () => {
  ...
  const hotspots = [
    ...
    { x: 620, y: 310, imageUrl: `${process.env.PUBLIC_URL}/assets/photo1.png`,galleryImages: [`${process.env.PUBLIC_URL}/assets/photo1.png`, `${process.env.PUBLIC_URL}/assets/photo1.png`], label: 'Central Library' },
